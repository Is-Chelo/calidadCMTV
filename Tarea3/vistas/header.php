<?php 
// comprobamos si tenemos alguna ssessionstart activo
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="../files/usuarios/<?php echo $_SESSION['imagen'];?>" width="50px" heigth="50px" alt="User Image">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="../ajax/usuario.php?opcion=salir" class="btn btn-default btn-flat">Cerrar</a>
                    </div>
                  </li>
                </ul>
              </li>
